...
public class WebConfiguration extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
    ...
    @Bean(name = "counterPoints")
    public CounterPoints getCounterPointsMBean(){ return new CounterPoints();}

    @Bean(name = "counterPercent")
    public CounterPercent getCounterPercentMBean(){ return new CounterPercent();}


    @Bean
    public SimpleAgent getSimpleAgent(){ return new SimpleAgent(getCounterPointsMBean(),getCounterPercentMBean());}
